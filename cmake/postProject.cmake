if(TARGET ${PROJECT_NAME})
    ...
    set_property(TARGET ${PROJECT_NAME} APPEND PROPERTY COMPILE_DEFINITIONS $<$<CONFIG:Debug>:SOFA_LIBSUFFIX=${LIBSUFFIX}d>)
    set_property(TARGET ${PROJECT_NAME} APPEND PROPERTY COMPILE_DEFINITIONS $<$<CONFIG:Release>:SOFA_LIBSUFFIX=${LIBSUFFIX}>)
    set_property(TARGET ${PROJECT_NAME} APPEND PROPERTY COMPILE_DEFINITIONS $<$<CONFIG:RelWithDebInfo>:SOFA_LIBSUFFIX=${LIBSUFFIX}>)
    set_property(TARGET ${PROJECT_NAME} APPEND PROPERTY COMPILE_DEFINITIONS $<$<CONFIG:MinSizeRel>:SOFA_LIBSUFFIX=${LIBSUFFIX}>)
