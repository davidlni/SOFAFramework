...
******************************************************************************/
#ifndef SOFA_COMPONENT_COLLISION_CONTINUOUSPENALITYCONTACT_H
...
class ContinuousPenalityContact : public core::collision::Contact
{
public:
    SOFA_CLASS(SOFA_TEMPLATE3(ContinuousPenalityContact, TCollisionModel1, TCollisionModel2, ResponseDataTypes), core::collision::Contact);
...
protected:
    ...
    ContinuousPenalityContact(CollisionModel1* model1, CollisionModel2* model2, Intersection* intersectionMethod);
    ~ContinuousPenalityContact();
