...
******************************************************************************/
#ifndef SOFA_COMPONENT_COLLISION_CONTINUOUSPENALITYCONTACT_INL
#define SOFA_COMPONENT_COLLISION_CONTINUOUSPENALITYCONTACT_INL

#include "ContinuousPenalityContact.h"
...
ContinuousPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::ContinuousPenalityContact(CollisionModel1* _model1, CollisionModel2* _model2, Intersection* _intersectionMethod)
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
ContinuousPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::~ContinuousPenalityContact()
{
}


template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
void ContinuousPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::cleanup()
{
    if (ff!=NULL)
    {
        ff->cleanup();
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
void ContinuousPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::setDetectionOutputs(OutputVector* o)
{
    ...
    for (int i=0; i<insize; i++)
    {
        ...
        else
        {
            ...
            {
                ++nbnew;
                if (printLog) sout << "ContinuousPenalityContact: New contact "<<o->id<<sendl;
            }
        }
    ...
    for (ContactIndexMap::iterator it = contactIndex.begin(), itend = contactIndex.end(); it != itend; )
    {
        ...
        if (index >= 0)
        {
            if (printLog) sout << "ContinuousPenalityContact: Removed contact "<<it->first<<sendl;
    ...
    if (printLog) sout << "ContinuousPenalityContact: "<<insize<<" input contacts, "<<size<<" contacts used for response ("<<nbnew<<" new)."<<sendl;
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
void ContinuousPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::createResponse(core::objectmodel::BaseContext* group)
{
    if (ff!=NULL)
    {
        if (parent!=NULL)
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
void ContinuousPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::removeResponse()
{
    if (ff!=NULL)
    {
        if (parent!=NULL)
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
void ContinuousPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::draw(const core::visual::VisualParams* )
{
    //	if (ff!=NULL)
    //		ff->draw(vparams);
}
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes >
void ContinuousPenalityContact<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::setInteractionTags(MechanicalState1* mstate1, MechanicalState2* mstate2)
{
