...
******************************************************************************/
#ifndef SOFA_COMPONENT_INTERACTIONFORCEFIELD_CONTINUOUSPENALITYCONTACTFORCEFIELD_H
#define SOFA_COMPONENT_INTERACTIONFORCEFIELD_CONTINUOUSPENALITYCONTACTFORCEFIELD_H
...
class ContinuousPenalityContactForceField : public core::behavior::PairInteractionForceField<DataTypes>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE(ContinuousPenalityContactForceField, DataTypes), SOFA_TEMPLATE(core::behavior::PairInteractionForceField, DataTypes));
...
protected:
    ...
    ContinuousPenalityContactForceField(MechanicalState* object1, MechanicalState* object2)
        : Inherit(object1, object2), contacts(initData(&contacts,"contacts", "Contacts"))
    {
    }

    ContinuousPenalityContactForceField()
    {
    }
public:
    void clear(int reserve = 0);

    void addContact(const int &m1, const int &m2, const int &index1, const int &index2, const Deriv& norm, const Real &dist, const Real &ks, const Real &mu_s = 0.0f, const Real &mu_v = 0.0f, const int &oldIndex = 0);
...
#ifndef SOFA_FLOAT
extern template class SOFA_OBJECT_INTERACTION_API ContinuousPenalityContactForceField<defaulttype::Vec3dTypes>;
#endif
#ifndef SOFA_DOUBLE
extern template class SOFA_OBJECT_INTERACTION_API ContinuousPenalityContactForceField<defaulttype::Vec3fTypes>;
#endif
#endif
