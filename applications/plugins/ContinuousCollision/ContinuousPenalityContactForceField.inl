...
******************************************************************************/
#ifndef SOFA_COMPONENT_INTERACTIONFORCEFIELD_CONTINUOUSPENALITYCONTACTFORCEFIELD_INL
#define SOFA_COMPONENT_INTERACTIONFORCEFIELD_CONTINUOUSPENALITYCONTACTFORCEFIELD_INL
...
void ContinuousPenalityContactForceField<DataTypes>::clear(int reserve)
{
...
template<class DataTypes>
void ContinuousPenalityContactForceField<DataTypes>::addContact(const int &m1, const int &m2, const int &index1, const int &index2, const Deriv& norm, const Real &dist, const Real &ks, const Real &mu_s, const Real &mu_v, const int &oldIndex)
{
...
template<class DataTypes>
void ContinuousPenalityContactForceField<DataTypes>::addForce(const core::MechanicalParams* /*mparams*/ /* PARAMS FIRST */, DataVecDeriv& data_f1, DataVecDeriv& data_f2, const DataVecCoord& data_x1, const DataVecCoord& data_x2, const DataVecDeriv& /*data_v1*/, const DataVecDeriv& /*data_v2*/ )
{
...
template<class DataTypes>
void ContinuousPenalityContactForceField<DataTypes>::addDForce(const core::MechanicalParams* mparams /* PARAMS FIRST */, DataVecDeriv& data_df1, DataVecDeriv& data_df2, const DataVecDeriv& data_dx1, const DataVecDeriv& data_dx2)
{
    ...
    Real kFactor = mparams->kFactorIncludingRayleighDamping(this->rayleighStiffness.getValue());
...
template <class DataTypes>
double ContinuousPenalityContactForceField<DataTypes>::getPotentialEnergy(const core::MechanicalParams* /* PARAMS FIRST */, const DataVecCoord&, const DataVecCoord& ) const
{
    serr<<"ContinuousPenalityContactForceField::getPotentialEnergy-not-implemented !!!"<<sendl;
    return 0;
}

template<class DataTypes>
void ContinuousPenalityContactForceField<DataTypes>::draw(const core::visual::VisualParams* vparams)
{
...
template<class DataTypes>
void ContinuousPenalityContactForceField<DataTypes>::grabPoint(
